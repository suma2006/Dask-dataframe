...
```py
![Dashboard
Screenshot]("C:\Users\hp\Downloads\Screenshot (6).png")
```
...
```py
![Dashboard
Screenshot]("C:\Users\hp\Downloads\Screenshot (12).png")
```
...
```py
![Dashboard
Screenshot]("C:\Users\hp\Downloads\Screenshot (8).png")
```
...
```py
![Dashboard
Screenshot](""C:\Users\hp\Downloads\Screenshot (7) (2).png"")
```
...
```py
![Dashboard
Screenshot]("C:\Users\hp\Downloads\Screenshot (10).png")
```
...
```py
![Dashboard
Screenshot](C:\Users\hp\Downloads\Screenshot (11).png)
```
