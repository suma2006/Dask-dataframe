...
# df.describe(): Computes summary statistics (like mean, standard deviation, min, etc.) for numerical columns in the dataset.
# .compute(): Converts the lazy Dask computation into an actual Pandas DataFrame by executing it.
print(desc_stats)
# Displays the result.
